...
const tableObj = function(name){
	...
	this.addOptions = function(){
		...
		for(let i=0;i<list.length;i++){
			...
			jQuery(list[i]).append("<div class='optionsTable'><div id='remove"+id+"' onclick='buildingFormsModule.createDMTableRemove(this)' class='icon remove'></div></div>");
		}
	}
...
jQuery("head").append("<style>.hide{display:none !important;}.sum.icon{background-image:url(https://quereps.github.io/buildingForm/images/summary.png); }  .getScoreFormula.icon{background-image:url(https://quereps.github.io/buildingForm/images/grade.png);}"+
